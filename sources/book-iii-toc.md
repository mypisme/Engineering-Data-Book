...
| 2 | Design Considerations for Enhanced Heat Exchangers | 强化换热器设计考虑 | 37-46 | 2-1 到 2-10 | P1 | 出版级二校完成 | 强化换热、设计权衡、压降、成本、污垢 |
| 3 | Single-Phase Shell-Side Flows and Heat Transfer | 单相壳侧流动与传热 | 47-66 | 3-1 到 3-20 | P1 | 出版级二校完成 | Taborek、Delaware、壳侧流路、折流板、压降 |
