...
| 文件 | 用途 | 状态 |
|---|---|---|
| [translation.md](./translation.md) | 忠实译文；图表随文放置；主公式用 LaTeX 转写；Table 6.1、Table 6.2、Table 6.3 已补公式转写草稿并保留原表截图 | 工程阅读草稿；大型公式表仍需出版级逐式二校 |
| [commentary.md](./commentary.md) | 面向具备基础传热和换热器常识读者的深入解读 | 完整解读草稿 |
...
- 主公式以块级 LaTeX 重排。
- 原式截图在正文公式旁保留。
- Table 6.1 是 19 页大型关联式表，当前已补中文索引和公式转写草稿并保留局部表格截图；后续二校应逐式复核 LaTeX 和适用范围。
