...
| 2026-04-25 | 公式疑点复核 | 式 (2.34)/(2.35) 已按原式截图核定；二者同向不等式不是 OCR 遗留疑点 |
| 2026-04-25 | 图表截图复核 | Fig. 2.26、Fig. 2.33 已重裁为局部图表；其余大幅 F 因子图为整幅图表而非整页截图 |
| 2026-04-25 | 例题算术复核 | 例题 2.7.1/2.7.2 的热负荷、流量、壳侧传热系数、所需面积、管长等关键节点复算通过；最大相对偏差约 0.72%，属于原书取整范围 |
| 2026-04-25 | 剩余人工项 | Delaware 几何单位、表 2.1-2.7 数值仍需逐项二校 |
...
| 2026-04-25 | 例题 2.7.1/2.7.2 关键算术节点复算 | 通过 |
